...
func Start() {
	...
	if err != nil {
		app.Logger().WithField("log_type", "foundation.orm.orm").Warn("database connect error, you can't use orm support: ")
		app.Logger().WithField("log_type", "foundation.orm.orm").Warn(err)
	}
